...
/** Personal AI credit wallet — used for Tag / Sync / Propose-cut. */
export default function PersonalCreditsCard() {
  ...
  const grantTest = useCallback(async () => {
    ...
    try {
      ...
      setMessage(`Granted ${amount} credits to your account.`);
    } catch (e) {
  ...
  return (
    <section className={panelClass}>
      <div className="mb-2 flex flex-wrap items-center justify-between gap-2">
        <h2 className="text-sm font-semibold text-white">Your AI credits</h2>
        {!purchaseEnabled ? (
      ...
      <p className="mb-3 text-xs leading-relaxed text-zinc-500">
        Personal balance for AI Tag, Sync, and highlight cuts — not club shared.
      </p>
      ...
      {!purchaseEnabled ? (
        ...
        <p className="text-[11px] text-zinc-500">
          Purchase flow coming soon — your wallet is ready.
        </p>
      )}
