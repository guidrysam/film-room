...
export type HighlightDraftMeta = {
  ...
  titleLogoUrl?: string;
  /** Custom thank-you copy on black sponsor cuts. */
...
export function serializeHighlightDraftMeta(
  ...
  const thanks = thankYouMessage?.trim() || "";
...
export function highlightDraftFromTrack(track: DirectorTrack): HighlightDraft | null {
  ...
  return {
    ...
    ...(meta.thankYouMessage ? { thankYouMessage: meta.thankYouMessage } : {}),
